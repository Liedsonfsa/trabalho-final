...
int main(int argc, char **argv) {
    ...
    ordenar(sumario);    
    //C:\Users\fabri\Algoritmos2\trabalho-final> xxxx.exe 2 C:\Users\fabri\Algoritmos2\trabalho-final\output\textoingles.txt 2 C:\Users\fabri\Algoritmos2\trabalho-final\output\stopow2.txt C:\Users\fabri\Algoritmos2\trabalho-final\testandoinlges.txt
...
void preencher(Texto *texto, char *arq[]){
    ...
    if(file){
        ...
        printf("Arquivo nao encontrado! %c\n", 3);
    }
}
